...
image:https://github.com/Decathlon/ara/actions/workflows/build.yaml/badge.svg[BUILD] image:https://github.com/Decathlon/ara/actions/workflows/charts-release.yaml/badge.svg[CHARTS]
