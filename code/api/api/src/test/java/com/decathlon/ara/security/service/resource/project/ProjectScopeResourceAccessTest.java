...
class ProjectScopeResourceAccessTest {
    ...
    @InjectMocks
    private ProjectScopeResourceAccess projectScopeResourceAccess;
    ...
    void isEnabled_returnFalse_whenResourcePermissionIsNull() {
        ...
        // Then
        var isEnabled = projectScopeResourceAccess.isEnabled(projectCode, null);
        assertThat(isEnabled).isFalse();
    }
