...
NOTE: You can either add the data directly into your database, or use the ARA setting to do so (_select your project_ > `Manage project` > (`SOURCES` | `TYPES`), which is *recommended*.
