...
* *OAuth2 providers*:
** *Github*:
*** `*authentication.clients.github.enabled*`: a boolean to enable or disable the Github authentication
...
** *Google*:
*** `*authentication.clients.google.enabled*`: a boolean to enable or disable the Google authentication
...
** *Custom*:
*** `*authentication.clients.custom.enabled*`: a boolean to enable or disable the custom authentication
